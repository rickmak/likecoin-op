...
# Generated from 8453-47542905.json @ block 47542905.
# Pools to reset: 56  |  positions: 433.
#
...
#   * After this completes, sweep 48384.355513 LIKE (adminSweep)
...
# pool 15/56  0x4D69ecb8Da3B16D5828eC0DCd17B1310Cb96D3A0  4pos  recorded 210300.0 -> true 210486.337084 LIKE  [index was INFLATED]
cast send "$COLLECTIVE" "adminResetPool(address,uint256[],uint256)" 0x4D69ecb8Da3B16D5828eC0DCd17B1310Cb96D3A0 "[1470,1433,1441,1539]" 210486337084 \
    --rpc-url "$RPC_URL" --account "$OWNER_ACCOUNT"
...
# pool 43/56  0xD08EB66DAe9Bad58626ac4ED6A4a102b134b7457  14pos  recorded 144886.36 -> true 145117.847762 LIKE  [index was INFLATED]
cast send "$COLLECTIVE" "adminResetPool(address,uint256[],uint256)" 0xD08EB66DAe9Bad58626ac4ED6A4a102b134b7457 "[909,1547,1088,908,915,916,929,934,938,951,1081,1543,1397,1351]" 145117847762 \
    --rpc-url "$RPC_URL" --account "$OWNER_ACCOUNT"
...
echo "adminResetPool complete. Runbook next: adminSweep 48384.355513 LIKE, then unpause()."
